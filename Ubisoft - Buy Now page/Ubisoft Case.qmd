...
Minimum of visitors is the conservative choice. The mean can have disadvantage (see more).
...
Correct answer: higher power 0.9 (reduce the rate of false negatives, increasing the sample size) and higher alpha 0.1 (increase the rate of false positive, reducing the sample size). If you use alpha = 0.1, it will be the statistically significant threshold.
